...
| Modularity | B | 75 | Layered backend, component-based Angular frontend, but flat packages without domain grouping |
| Code Quality | B | 79 | Java type safety, Angular signals, ESLint/Stylelint, MapStruct, Spring validation |
| Testing | C | 73 | 583 test files, strong frontend ratio (0.87), but lower backend ratio (0.22) |
| Documentation | B | 80 | 19 markdown files, OIDC setup guides, contributing guide, governance, deployment docs |
| Performance Design | C | 74 | MariaDB with JPA, WebSocket, zoneless Angular, TanStack Query, but limited caching evidence |
| Developer Experience | B | 80 | Justfile automation, Docker dev setup, 13 CI workflows, mise.toml, semantic PR validation |
| Long-Term Sustainability | B | 81 | Modern stack (Java 25, Angular 21, Spring Boot 4), semantic versioning, release automation, CodeQL |
...
## Best Attribute
Long-Term Sustainability (81/100)
