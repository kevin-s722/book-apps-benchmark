...
| Total Files | ~3,090 |
| Source Files | ~1,372 (699 server TS + 673 client TS/Vue) |
| Test Files | 638 (463 server + 175 client) |
| Languages | TypeScript, Vue 3 (SFC), SQL |
| Dependency Count | 153 (server: 85, client: 57, root: 11) |
| Largest Module | metadata-fetch (83 files) |
| Build System | pnpm monorepo, Vite (client), Nest CLI/SWC (server) |
| CI/CD Present | Yes - 7 GitHub Actions workflows (711 lines in ci.yml alone) |
| Containerization Present | Yes - multi-stage Dockerfile, docker-compose.yml, docker-compose.dev.yml |
...
| Security | A | 84 | Comprehensive auth/RBAC, global guards, CSP headers, input validation, ownership enforcement |
...
| Code Quality | A | 84 | Consistent patterns, strong typing, linting (ESLint + Oxlint + Prettier), decorator-based validation |
...
| Performance Design | B | 76 | Connection pooling, SPA static serving, caching infrastructure, but limited evidence of profiling |
...
## Best Attribute: Modularity (86/100)
## Weakest Attribute: Documentation (75/100)
